...
<div class="containter-max-width d-flex mr-auto flex-direction-row job-content">
    <div style="width:100%">
        <header class="advanced-filter d-flex">
            <div class="d-flex">
                <div class="li mopt job-type">
                    <span class="label">Tất cả loại job </span>
                    <span class="icon"><i class="fa fa-angle-down" aria-hidden="true"></i> </span>
                    <div class="opts"> 
                        <div class="opt">Office </div>
                        <div class="sep-item"> </div>
                        <div class="opt">Onsite </div>
                        <div class="sep-item"> </div>
                        <div class="opt">Remote </div>
                    </div>
                </div>
                <div class="li mopt post-time">
                    <span class="label">Thời gian đăng </span>
                    <span class="icon"><i class="fa fa-angle-down" aria-hidden="true"></i> </span>
                    <div class="opts"> 
                        <div class="opt url" data-since="3" data-filter="since">Gần đây nhất </div>
                        <div class="sep-item"> </div>
                        <div class="opt url" data-since="7" data-filter="since"> 7 ngày trước </div>
                        <div class="sep-item"> </div>
                        <div class="opt url" data-since="30" data-filter="since"> 30 ngày trước </div>
                        <div class="sep-item"> </div>
                        <div class="opt url" data-since="60" data-filter="since">  60 ngày trước</div>
                    </div>
                </div>
                <div class="li">
            ...
            <div class="clear-filter d-flex align-item-center"> <span onclick="Job.clearFilter()">Clear filters</span></div>
        </header>
        <div class=" d-flex">
            <section id="js-jobs" class="col-lg-5">
                <div class="header d-flex">
                    <div class="title">
                        <span class="svg"><svg class="SVGInline-svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="currentColor" fill-rule="evenodd"><path id="prefix__icon-sort-descending-1" d="M21 5a1 1 0 010 2H3a1 1 0 010-2zm-6 6a1 1 0 010 2H3a1 1 0 010-2zm-4 6a1 1 0 010 2H3a1 1 0 010-2z"></path></g></svg></span>
                        Kết quả tìm kiếm
                    </div>   
                    <div class="count-result"> 78 for software engineer hanoi </div>
                </div>
                ...
                <div class="header">
                    <div class="main d-flex">
                        ...
                        <div class="content-right d-flex col-lg-5"> 
                            <div class="btn-apply url" onclick="Job.apply({{ $job['id'] }})">
                                <span class="icon"><i class="fa fa-hand-o-right" aria-hidden="true"></i></span>
                                 Apply now</div>
                            <div class="btn-save url" onclick="Job.save({{ $job['id'] }})"><span class="svg"><svg class="SVGInline-svg heart-svg save-svg margRtXs-svg css-zve8bc-svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="currentColor" fill-rule="evenodd"><path id="prefix__icon-save-1" d="M12 5.11l.66-.65a5.56 5.56 0 017.71.19 5.63 5.63 0 010 7.92L12 21l-8.37-8.43a5.63 5.63 0 010-7.92 5.56 5.56 0 017.71-.19zm7.66 6.75a4.6 4.6 0 00-6.49-6.51L12 6.53l-1.17-1.18a4.6 4.6 0 10-6.49 6.51L12 19.58z"></path></g></svg></span> Save</div>
...
<script>
    ...
    Job.list();
    Job.search.searchOpt();
    $(".count-result").html(` ${Client.pageData.jobs.length} kết quả tìm kiếm cho  ${__(Client.pageData.params.keyword)}  ${__(Client.pageData.params.location)}`);
    
    if(Client.pageData.job)
    {
        $(".content .job-info").html(Client.pageData.job.description);
    }
</script>
@endsection
